...
ActiveRecord::Schema.define(version: 2020_01_08_152846) do
  ...
  create_table "applications", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "job_advertisement_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["job_advertisement_id"], name: "index_applications_on_job_advertisement_id"
    t.index ["user_id"], name: "index_applications_on_user_id"
  end

  create_table "job_advertisements", force: :cascade do |t|
    t.string "name", null: false
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["organization_id"], name: "index_job_advertisements_on_organization_id"
  end
